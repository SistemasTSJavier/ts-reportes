-- =============================================================================
-- FIX: "Direct deletion from storage tables is not allowed. Use the Storage API instead."
-- Pegar en Supabase → SQL Editor → Run
-- Luego recarga el panel admin y vuelve a Eliminar datos.
-- =============================================================================

begin;

-- El panel borra archivos con Storage API. Esta función ya no hace DELETE en storage.objects.
