-- FIX RÁPIDO para /panel-admin (pegar en SQL Editor si aún no aplicaste migraciones)
-- Crea locks + RPCs admin_list_user_overview / admin_update_user_drive_config
