...
-- Trigger legado: insertaba en registros_ctpat_audit, tabla que ya no existe.
do $$
declare
  r record;
begin
...
-- Solo lectura: el usuario ve sus propios eventos; admin ve todo.
...
-- Inmutabilidad: nadie puede modificar ni borrar filas vía API.
